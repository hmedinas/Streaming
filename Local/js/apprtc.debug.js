  ...
  return function e(t, n, r) {
    ...
    module.exports = function(window, edgeVersion) {
      ...
      RTCPeerConnection.prototype.setRemoteDescription = function(description) {
        ...
        sections.forEach(function(mediaSection, sdpMLineIndex) {
          ...
          if (description.type === "offer" && !rejected) {
            ...
            if (cands.length) {
              if (isComplete && (!usingBundle || sdpMLineIndex === 0) && transceiver.iceTransport.state === "new") {
            ...
            if (description.type === "answer" && !rejected) {
              ...
              if (cands.length) {
                if ((isIceLite || isComplete) && (!usingBundle || sdpMLineIndex === 0) && iceTransport.state === "new") {
      ...
      RTCPeerConnection.prototype.createOffer = function() {
        ...
        this.transceivers.forEach(function(transceiver, sdpMLineIndex) {
          sdp += writeMediaSection(transceiver, transceiver.localCapabilities, "offer", transceiver.stream);
          sdp += "a=rtcp-rsize\r\n";
      ...
      RTCPeerConnection.prototype.createAnswer = function() {
        ...
        this.transceivers.forEach(function(transceiver, sdpMLineIndex) {
          ...
          sdp += writeMediaSection(transceiver, commonCapabilities, "answer", transceiver.stream);
    ...
    var firefoxShim = {shimOnTrack:function(window) {
      ...
      if (typeof window === "object" && window.RTCPeerConnection && "receiver" in window.RTCTrackEvent.prototype && !("transceiver" in window.RTCTrackEvent.prototype)) {
